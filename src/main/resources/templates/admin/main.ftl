...
<body>
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            ...
            <span class="sys-title">Moea教学管理系统</span>
            <ul class="ht-nav">
            ...
            <div class="layui-side-scroll">
                <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                    ...
                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-user"></i>算法</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="${ctx!}/algorithmic/index" data-id="1">算法编辑</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-user"></i>资源管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="${ctx!}/admin/resource/index" data-id="3">资源管理</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-user"></i>用户管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="${ctx!}/admin/user/index" data-id="4">用户管理</a></dd>
                        </dl>
                    </li>

                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-user"></i>留言管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="${ctx!}/comment/index" data-id="5">留言管理</a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
